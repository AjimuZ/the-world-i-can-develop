...
- Initial repository and Claude Code setup.
- Add repository hygiene baseline: root `.gitignore`, MIT `LICENSE`, `.editorconfig`, `.gitattributes`, and `.env.example`.
- Add Claude changelog reminder hook and changelog maintainer skill.
